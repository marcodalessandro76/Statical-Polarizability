# Alternative version of workflow.py in which the setting of omp and mpi is absentself.
# In this case these parameters are passed exporting the associated variables in the slurm
# script that launches the python.
...
def single_study_workflow(alpha_conv=1.0e-2,wf_convergence=1.0e-6,hgrids=0.3,rmult_fine=9.0,term_verb=True,**kwargs):
    """
